...
var userOrderCommonErrorRules = []mappedHandlerError{
	...
	{target: service.ErrCardSecretInvalid, code: response.CodeBadRequest, key: "error.card_secret_invalid"},
	{target: service.ErrCardSecretSelectionConflict, code: response.CodeBadRequest, key: "error.card_secret_selection_conflict"},
