...
var messages = map[string]map[string]string{
	LocaleZH: {
		...
		"error.card_secret_selection_conflict":     "同一商品不能混用自选卡密和普通卡密，请先清空现有库存后再切换",
	...
	LocaleTW: {
		...
		"error.card_secret_selection_conflict":     "同一商品不能混用自選卡密和普通卡密，請先清空現有庫存後再切換",
	...
	LocaleEN: {
		...
		"error.card_secret_selection_conflict":     "Selectable and regular card secrets cannot be mixed under the same product until existing stock is cleared",
